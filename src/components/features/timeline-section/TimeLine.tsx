...
import { FaAddressBook, FaGraduationCap, FaRegBookmark } from "react-icons/fa";
...
return (
  <div className="bg-background min-h-screen  relative container timeline py-10">
    <div className="flex items-center justify-between">
      <div className="border-s-4 border-s-accent ps-4 text font-semibold timeline-label">How It Works</div>
      <div><FaGraduationCap className="text-4xl md:text-6xl timeline-icon" /></div>
    </div>
